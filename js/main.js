...
// * Crea las variables para los datos
var usuario_nombre,
    usuario_edad,
    usuario_pais,
    usuario_correo
...
function agregarUsuarios(e){
  ...
  usuario_edad = parseInt(formulario.edad.value.trim())     //* ParseInt convierte el valor a entero
  ...
  if(formulario_valido()){
    ...
    peticion.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded') // * Establece el tipo de datos que se enviaran
    ...
    error_box.classList.add('active')
    error_box.innerHTML = 'Por favor, llene todos los campos correctamente'
  }
}
